$(document).ready(function () {
    ...
    function quizBuild() {
        ...
        quiz[2] = new quizConstructor('2012 Yılında 1 USD kaç YTL ediyordu ? ', '1,8 YTL', '2,1 YTL', '8,7 YTL', '1,6 YTL', 1, "/usd.jpeg", false,);
        quiz[3] = new quizConstructor('Dance Dance şarksını seslendiren bu grup kimdir ? ', 'AC/DC ', 'Linkin Park', 'Fall Out Boy', 'The Killers', 3, "", false, "milyoner/pics/dance.mp4");
